...
public class RedisUtil {
    ...
    public Long zdel(String key, Object obj){
        return redisTemplate.opsForZSet().remove(key,obj);
    }

    public Double zincreby(String key, Object value, double increby){
        return redisTemplate.opsForZSet().incrementScore(key,value,increby);
    }
    ...
    public long getZtotalNumber(String key){
        return redisTemplate.opsForZSet().size(key);
    }

    public Set<Integer> getZrangeItems(String key, long start, long end){
        return redisTemplate.opsForZSet().range(key,start,end);
    }

    public Set<Integer> getZrevaRangeItems(String key, long start, long end){
